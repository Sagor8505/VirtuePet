...
public class Registration extends JFrame {
    ...
    Registration() {
		...
		*/
        ...
        label1.setBounds(420, 65, 500, 50);
        label1.setFont(f1);
        c.add(label1);
        ...
        label1.setBounds(425, 100, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf1 = new JTextField();
        tf1.setBounds(565, 110, 260, 30);
        tf1.setFont(f5);
        c.add(tf1);
        ...
        label1.setBounds(425, 135, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf2 = new JTextField();
        tf2.setBounds(565, 145, 260, 30);
        tf2.setFont(f5);
        c.add(tf2);
        ...
        label1.setBounds(425, 170, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf3 = new JPasswordField();
        tf3.setBounds(565, 180, 260, 30);
        tf3.setFont(f2);
        tf3.setEchoChar('*');
        c.add(tf3);
        ...
        label1.setBounds(425, 205, 500, 50);
        label1.setFont(f4);
        c.add(label1);
        ...
        securityQsn.setBounds(565, 215, 259, 30);
        ...
        label1.setBounds(425, 240, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf4 = new JTextField();
        tf4.setBounds(565, 250, 260, 30);
        tf4.setFont(f5);
        c.add(tf4);
        ...
        label1.setBounds(425, 275, 500, 50);
        label1.setFont(f4);
        c.add(label1);

        tf5 = new JTextField();
        tf5.setBounds(610, 285, 215, 30);
        tf5.setFont(f5);
        c.add(tf5);
        ...
        label1 = new JLabel();
        label1.setText(" " + a + " + " + b + " ");
        label1.setBounds(525, 285, 75, 30);
        label1.setFont(f4);
