...
public class AdminLogins extends JFrame {
    ...
    AdminLogins() {
        ...
        f2 = new Font("Times New Roman", Font.BOLD, 60);
        ...
        label1.setBounds(450, 70, 500, 90);
        label1.setFont(f2);
        c.add(label1);
        ...
        btn5.setBounds(1000, 500, 150, 30);
        btn5.setFont(f5);
                        ...
                        for (int i = 0; i <= totalLines; i++) {
                            ...
                            if (line.equals(userNameS)) {
                                ...
                                if (line2.equals(passwordS)) {
                                    JOptionPane.showMessageDialog(null, "Admin Login Successful.", "AdoptPet!",
                                            JOptionPane.WARNING_MESSAGE);
    ...
    public static void main(String[] args) {
        ...
        AdminLogins frame = new AdminLogins();
        frame.setVisible(true);
    }
}
