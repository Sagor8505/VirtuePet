...
public class UserData extends JFrame {
    ...
    private JButton btn1, btn2, btn3, btn4, btn6, btn7, nBtn;
    ...
    UserData() {
        ...
        label1.setBounds(450, 15, 400, 80);
        label1.setFont(f1);
        c.add(label1);

        // JButtons
        btn1 = new JButton("Refresh");
        btn1.setBounds(325, 418, 184, 50);
        btn1.setFont(f2);
        ...
        btn7.setBounds(1000, 500, 100, 30);
        btn7.setFont(f2);
        ...
        scroll.setBounds(54, 96, 1092, 300);
